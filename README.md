...
Every input is $\mathcal{F}_t$-measurable, every split is chronological and embargoed, and each structural claim in the design carries a proof. See [`DUAL_HEAD_TLSTM_SPEC.md`](DUAL_HEAD_TLSTM_SPEC.md).
